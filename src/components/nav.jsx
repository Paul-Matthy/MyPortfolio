...
const nav = () => {
  ...
  const closeNavStyling = "fixed bg-zinc-800 text-white w-1/2 right-0 h-screen top-0 transition-all translate-x-full flex-col pt-32 px-8 lg:translate-x-0 lg:text-sm lg:p-0 lg:h-auto lg:flex lg:gap-10 lg:flex-row lg:static lg:w-auto lg:bg-transparent hover:text-zinc-450"
